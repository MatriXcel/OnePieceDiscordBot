...
namespace OnePieceDiscoBot.Commands
{
    ...
    public abstract class Anime : ModuleBase
    {
        ...
        protected abstract Task charInfo(string charName);
        protected abstract Task powerInfo(string powerName);

        protected async Task<String> getCharacterLink(String siteLink, String xpath, String charName)
        {
        ...
        protected async Task<String> getPowerLink(String siteLink, string xpath, String dfName)
        {
            String link = String.Empty;
        ...
        public abstract Task<String> getTriviaInfo(String charSite);
        protected async Task<String> getTriviaInfo(String charSite, String xpath)
        {
        ...
        public async Task<String> getAbilityInfo(String charSite, String xpath)
        {
            var doc = await Task.Factory.StartNew(() => web.Load(charSite));
            if (doc == null) { Console.WriteLine("doc failed to load"); return ""; }
            ...
            foreach (var header in headerNodes)
            {
                if (header.InnerText.Contains("Abilities"))
                {
